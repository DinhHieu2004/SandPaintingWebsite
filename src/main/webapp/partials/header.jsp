...
<header id="header-container" class="fixed-top">
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg">
            <!-- Logo -->
            <a class="navbar-brand" href="../web_war/index">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../web_war/artwork">TÁC PHẨM</a></li>
                    <li class="nav-item"><a class="nav-link" href="../web_war/discount">CHƯƠNG TRÌNH GIẢM GIÁ</a></li>
                    <li class="nav-item dropdown">
